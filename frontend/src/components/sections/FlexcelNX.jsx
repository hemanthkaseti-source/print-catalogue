    ...
    <div className="wrap py-24 md:py-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mt-20 items-start">
        <div className="lg:col-span-5 flex flex-col gap-10">
          <Reveal className="relative overflow-hidden aspect-[4/3] spotlight">
            <motion.img src={IMG.plateCylinder} alt="Flexcel NX plate mounted on sleeve" className="w-full h-full object-cover" initial={{ scale: 1.15 }} whileInView={{ scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.8, ease: EASE }} />
            <div className="absolute top-4 left-4 eyebrow !text-bone/80 bg-ink/50 backdrop-blur px-3 py-1.5">NX plate · sleeve-mounted</div>
          </Reveal>
        ...
        <Reveal delay={0.15} className="lg:col-span-7">
          ...
          <DotComparison />
          <p className="body mt-5 text-xs max-w-xl">Diagram is illustrative. Drag the slider to see how each dot type responds to increasing impression on press.</p>
        </Reveal>
      </div>
    </div>
  </section>
